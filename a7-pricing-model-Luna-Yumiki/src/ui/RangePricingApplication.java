...
public class RangePricingApplication {
  ...
  public static void main(String[] args) {
    ...
    Business business = ConfigureABusiness.createABusinessAndLoadALotOfData("Xerox", 30, 20, 30, 16, 6);
   ...
   // 3. Show some analytics (Summerizing, comparing, sorting, grouping data by some criteria)
    ...
    CustomersReport customersreport = cd.generatCustomerPerformanceReport();
